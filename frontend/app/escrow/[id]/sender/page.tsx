    ...
    <div className="relative min-h-screen text-white">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 py-10 sm:py-14">
        ...
        <div className="grid lg:grid-cols-2 gap-4">
          <section className="bg-neutral-900/60 backdrop-blur rounded-2xl p-5 border border-neutral-800">
            ...
            <div className="flex flex-wrap gap-2 mt-3">
              ...
              <button
                ...
                className="bg-indigo-600 hover:bg-indigo-500 disabled:opacity-50 rounded-lg px-3 py-2 text-sm"
              >
          ...
          <section className="bg-neutral-900/60 backdrop-blur rounded-2xl p-5 border border-neutral-800 lg:col-span-2">
          ...
          <section className="bg-neutral-900/60 backdrop-blur rounded-2xl p-5 border border-neutral-800 lg:col-span-2">
            ...
            <button
              ...
              className="w-full rounded-lg px-3 py-2 text-sm disabled:opacity-50 bg-emerald-600 hover:bg-emerald-500"
            >
